...
Thanks for your interest in contributing to Directory MCP Server! Here are a few
...
list](https://github.com/agntcy/dir-mcp/issues).
...
We welcome anyone that wants to contribute to Directory MCP Server to triage and
...
- Review and update the existing content of our
  [Wiki](https://github.com/agntcy/dir-mcp/wiki) with up-to-date
  instructions and code samples.
- Review existing pull requests, and testing patches against real existing
  applications that use `dir-mcp`.
- Write a test, or add a missing test case to an existing test.

Thanks again for your interest on contributing to `dir-mcp`!
