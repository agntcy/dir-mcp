...
The Directory MCP Server project team welcomes security reports and is committed to
...
users of Directory MCP Server, and maintainers of upstream dependencies if applicable.

Downstream project maintainers and Directory MCP Server users can request participation in
...
Participation in security issue coordination processes is at the discretion of the Directory MCP Server team.

## Security advisories

The project team is committed to transparency in the security issue disclosure
process. The Directory MCP Server team announces security issues via [project GitHub Release notes](https://github.com/agntcy/dir-mcp/releases).
